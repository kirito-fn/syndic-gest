...
import { Building2, LogIn, Sun, Moon } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-indigo-950 p-4 relative">
      <button onClick={toggle} className="absolute top-4 right-4 p-2.5 rounded-xl bg-white/80 dark:bg-gray-800/80 border border-gray-200 dark:border-gray-700 shadow-sm hover:bg-white dark:hover:bg-gray-800 transition-colors">
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-2xl shadow-xl dark:shadow-2xl dark:shadow-black/30 p-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white">SyndicGest</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Gestion de copropriété</p>
        </div>
